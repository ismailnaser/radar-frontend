import{r as t,p as f,v as y,j as e,L as n}from"./index-Csgqv13q.js";import{M as b,b as w,P as g}from"./MainLayout-DO4qX-Uc.js";import{c as j,a as N}from"./communityServiceCategoryVisual-BWfzN9ZR.js";const z=()=>{const[a,c]=t.useState([]),[d,l]=t.useState([]),[m,p]=t.useState(!0),x=localStorage.getItem("isGuest")==="true",v=!!localStorage.getItem("token")&&!x&&(localStorage.getItem("user_type")==="shopper"||localStorage.getItem("user_type")==="merchant"||localStorage.getItem("user_type")==="admin"),h="يجب إنشاء حساب وتسجيل الدخول كمتسوّق أو تاجر (وليس زائراً) لتتمكن من اقتراح نقطة خدمة مجتمعية.";t.useEffect(()=>{let r=!1;return(async()=>{try{const[s,i]=await Promise.all([f(),y()]);r||(c(Array.isArray(s)?s:[]),l(Array.isArray(i)?i:[]))}catch(s){console.error(s),r||(c([]),l([]))}finally{r||p(!1)}})(),()=>{r=!0}},[]);const u=t.useMemo(()=>{const r=new Map;for(const s of a)r.set(s.id,0);for(const s of d){const i=s.category;r.has(i)||r.set(i,0),r.set(i,r.get(i)+1)}return r},[a,d]);return e.jsx(b,{children:e.jsxs("div",{className:"services-page",children:[e.jsxs("header",{className:"services-hero",children:[e.jsx("div",{className:"services-hero-icon","aria-hidden":!0,children:e.jsx(w,{size:26,strokeWidth:2})}),e.jsx("h1",{className:"services-hero-title",children:"الخدمات المجتمعية"}),e.jsx("p",{className:"services-hero-sub",children:"نقاط طبية وتعليمية وتوزيع طعام ومياه ومؤسسات مجتمعية — تظهر على الخريطة بعد موافقة الإدارة."}),v?e.jsxs(n,{to:"/services/suggest",className:"services-cta",children:[e.jsx(g,{size:20,"aria-hidden":!0}),"اقترح نقطة خدمة"]}):e.jsxs(n,{to:`/register?next=${encodeURIComponent("/services/suggest")}`,state:{flash:h},className:"services-cta",children:[e.jsx(g,{size:20,"aria-hidden":!0}),"اقترح نقطة خدمة"]})]}),m?e.jsx("div",{className:"services-loading card",children:"جاري تحميل الأقسام…"}):a.length===0?e.jsx("p",{className:"services-empty",children:"لا توجد أقسام مفعّلة حالياً."}):e.jsx("div",{className:"services-grid",role:"list",children:a.map(r=>{const s=j(r.slug),i=N(r.slug),o=u.get(r.id)??0;return e.jsxs(n,{to:`/services/category/${encodeURIComponent(r.slug)}`,className:"services-grid-card card",role:"listitem",style:{"--svc-tone":s},children:[e.jsx("div",{className:"services-grid-card-visual","aria-hidden":!0,children:e.jsx("span",{className:"services-grid-card-emoji",children:i})}),e.jsxs("div",{className:"services-grid-card-body",children:[e.jsx("h2",{className:"services-grid-card-title",children:r.name}),r.description_hint?e.jsx("p",{className:"services-grid-card-hint",children:r.description_hint}):null,e.jsx("span",{className:"services-grid-card-count",children:o===0?"لا توجد نقاط بعد":`${o} ${o===1?"نقطة":"نقاط"} معتمدة`})]})]},r.id)})}),e.jsx("style",{dangerouslySetInnerHTML:{__html:`
          .services-page {
            max-width: 1240px;
            margin-inline: auto;
