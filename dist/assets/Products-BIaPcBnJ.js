import{f as P,a as E,r as i,j as e,L as d,P as L,I as _,D as S,F as U,G as A,H as R,J as D}from"./index-CQGeUD4O.js";import{M as H,D as T,f as $}from"./MainLayout-C4Pi49iX.js";import{I as F}from"./ImageCarousel-CZCyRIpb.js";import{v as l}from"./productImages-BYfYSUZM.js";import{I as y}from"./image-DOEUwOd8.js";import{U as G}from"./upload-y95zS2T4.js";import{P as O}from"./pencil-BSzq7_tS.js";import{T as W}from"./trash-2-CFtO7Qez.js";import"./chevron-left-BzmdLxAO.js";const J=P("Archive",[["rect",{width:"20",height:"5",x:"2",y:"3",rx:"1",key:"1wp1u1"}],["path",{d:"M4 8v11a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8",key:"1s80jp"}],["path",{d:"M10 12h4",key:"a56b0p"}]]),re=()=>{const{showAlert:n,showConfirm:w}=E(),[p,j]=i.useState([]),[k,m]=i.useState(!0),[h,x]=i.useState(!1),[o,u]=i.useState([]),c=async()=>{m(!0);try{const t=await S();j(t)}finally{m(!1)}};i.useEffect(()=>{c()},[]);const N=async t=>{await R(t.id,{is_archived:!t.is_archived}),await c()},I=async t=>{await w("متأكد بدك تحذف المنتج نهائياً؟","تأكيد الحذف")&&(await D(t.id),await c())},z=async()=>{try{const t=await U(),a=window.URL.createObjectURL(t),r=document.createElement("a");r.href=a,r.download=`منتجات_رادار_${new Date().toLocaleDateString("ar-EG").replace(/\//g,"-")}.xlsx`,document.body.appendChild(r),r.click(),window.URL.revokeObjectURL(a),document.body.removeChild(r)}catch{n("فشل تصدير الملف. حاول مرة أخرى.","خطأ")}},C=async t=>{var r,g,b,v,f;const a=(r=t.target.files)==null?void 0:r[0];if(a){x(!0);try{const s=await A(a,o);await n(s.message,"تم الاستيراد"),((g=s.skipped)!=null&&g.length||(b=s.errors)!=null&&b.length)&&console.warn("Import issues:",s),await c()}catch(s){const M=((f=(v=s.response)==null?void 0:v.data)==null?void 0:f.error)||"فشل استيراد الملف. تأكد من الصيغة والبيانات.";await n(M,"خطأ")}finally{x(!1),u([]),t.target.value=""}}},B=()=>{n(`يجب أن يكون ملف Excel بالصيغة التالية:
