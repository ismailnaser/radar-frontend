import{f as T,r as s,a as Y,$ as B,j as e,P as R,L as D,A as W,B as H,a0 as O,a1 as V}from"./index-C-uy7Y56.js";import{M as Z,i as J}from"./MainLayout-OjiTTNwV.js";import{G as K}from"./GuestAccessPrompt-DiShaBGE.js";import{f as _}from"./apiErrors-Bccm4O3Y.js";import{c as Q}from"./cartAccess-DdSevxjw.js";import{T as X}from"./trash-2-Vyx0CV_9.js";import"./CustomButton-L96wUOSq.js";const tt=T("ShoppingBag",[["path",{d:"M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4Z",key:"hou9p0"}],["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M16 10a4 4 0 0 1-8 0",key:"1ltviw"}]]),et=n=>typeof window>"u"||!n?"":`${window.location.origin}/share/cart/${n}`,C=n=>{const c=String(n||"").trim();return c?["Cart link:",`‭${c}‬`,c]:[]},ht=()=>{const[n,c]=s.useState([]),[z,$]=s.useState(!0),[rt,at]=s.useState(null),[it,nt]=s.useState(null),[S,ot]=s.useState(localStorage.getItem("isGuest")==="true"),{showAlert:d,showPrompt:I,showConfirm:A}=Y(),x=async()=>{try{const t=await W();c(t)}catch(t){console.error("Error fetching carts:",t)}finally{$(!1)}};s.useEffect(()=>{(async()=>{if(await x(),!!Q())try{const{notices:t}=await B(),r=Array.isArray(t)?t:[];for(const i of r){const o=typeof i=="string"?i:i==null?void 0:i.text;o&&await d(o,"تنبيه")}}catch{}})()},[]);const u=async()=>{const t=await I("أدخل اسم السلة الجديدة (مثل: أغراض المنزل):","اسم السلة...");if(t)try{await H(t),x()}catch(r){d(_(r,"تعذر إنشاء السلة."),"خطأ")}},w=t=>{var r;if(t.effective_unit_price!=null&&t.effective_unit_price!==""){const i=Number(t.effective_unit_price);if(Number.isFinite(i))return i}return Number(((r=t.product_details)==null?void 0:r.price)??0)},F=t=>{const r=t.catalog_unit_price;if(r==null||r==="")return null;const i=Number(r);return Number.isFinite(i)?i:null},m=t=>w(t)*Number(t.quantity??0),L=async t=>{let r=t.share_token!=null&&t.share_token!==""?String(t.share_token):"";if(!r)try{const a=await O(t.id);r=(a==null?void 0:a.share_token)!=null&&a.share_token!==""?String(a.share_token):""}catch{r=""}if(!r){d("تعذر الحصول على رابط المشاركة. تحقق من الاتصال بالخادم ثم حدّث الصفحة.","مشاركة السلة");return}const i=et(r),o=t.name||"سلة المشتريات",l=t.items||[],y=l.reduce((a,b)=>a+m(b),0),U=l.map((a,b)=>{const E=a.product_details||{},P=a.line_title||E.name||"منتج",k=w(a),f=F(a),q=Number(a.quantity??0),G=m(a);let p=`${b+1}) ${P}
