import{f as y,h as f,u as w,r as i,o as j,t as N,j as r,L as u}from"./index-CQGeUD4O.js";import{M as k,b as z}from"./MainLayout-C4Pi49iX.js";import{c as _,a as C}from"./communityServiceCategoryVisual-BWfzN9ZR.js";import{M}from"./map-pin-DgwUpEDZ.js";const S=y("ArrowLeft",[["path",{d:"m12 19-7-7 7-7",key:"1l729n"}],["path",{d:"M19 12H5",key:"x3x0zl"}]]),F=()=>{const{categorySlug:a}=f(),n=w(),[o,m]=i.useState([]),[p,g]=i.useState([]),[l,v]=i.useState(!0);i.useEffect(()=>{let e=!1;return(async()=>{try{const[t,c]=await Promise.all([j(),N()]);e||(m(Array.isArray(t)?t:[]),g(Array.isArray(c)?c:[]))}catch(t){console.error(t),e||(m([]),g([]))}finally{e||v(!1)}})(),()=>{e=!0}},[]);const s=i.useMemo(()=>o.find(e=>String(e.slug)===String(a)),[o,a]),x=i.useMemo(()=>s?p.filter(e=>Number(e.category)===Number(s.id)):[],[s,p]);i.useEffect(()=>{l||!o.length||(!a||!s)&&n("/services",{replace:!0})},[l,o.length,a,s,n]);const h=s?_(s.slug):"#1ebea5",b=s?C(s.slug):"✨",d=e=>{const t=Number(e==null?void 0:e.latitude),c=Number(e==null?void 0:e.longitude);return Number.isFinite(t)&&Number.isFinite(c)};return r.jsx(k,{children:r.jsxs("div",{className:"services-page services-category-page",children:[r.jsxs("nav",{className:"services-breadcrumb",children:[r.jsx(u,{to:"/services",className:"services-breadcrumb-link",children:"الخدمات المجتمعية"}),r.jsx("span",{className:"services-breadcrumb-sep","aria-hidden":!0,children:"/"}),r.jsx("span",{className:"services-breadcrumb-current",children:(s==null?void 0:s.name)||"…"})]}),r.jsxs("header",{className:"services-category-hero card",style:{"--cat-tone":h},children:[r.jsx("div",{className:"services-category-hero-visual","aria-hidden":!0,children:r.jsx("span",{className:"services-category-hero-emoji",children:b})}),r.jsx("h1",{className:"services-category-hero-title",children:(s==null?void 0:s.name)||"القسم"}),s!=null&&s.description_hint?r.jsx("p",{className:"services-category-hero-hint",children:s.description_hint}):null]}),l?r.jsx("div",{className:"services-loading card",children:"جاري تحميل النقاط…"}):x.length===0?r.jsx("p",{className:"services-empty card",children:"لا توجد نقاط معتمدة في هذا القسم بعد."}):r.jsx("ul",{className:"services-points",children:x.map(e=>r.jsxs("li",{className:"services-point",children:[r.jsx("div",{className:"services-point-title",children:e.title}),e.category_slug==="water"&&e.water_is_potable!=null?r.jsx("div",{className:"services-point-badge",children:e.water_is_potable?"مياه صالحة للشرب":"مياه غير صالحة للشرب"}):null,e.institution_scope?r.jsxs("div",{className:"services-point-meta",children:["النطاق: ",e.institution_scope_label||e.institution_scope]}):null,r.jsx("p",{className:"services-point-desc",children:e.detail_description}),r.jsx("p",{className:"services-point-address",children:e.address_text}),r.jsx("div",{className:"services-point-actions",children:r.jsxs("button",{type:"button",className:"services-point-mapbtn",disabled:!d(e),onClick:()=>{d(e)&&n("/map",{state:{mapFocus:{lat:e.latitude,lng:e.longitude,communityPointId:e.id},mapPreset:{mode:"community",cc:(s==null?void 0:s.id)??null}}})},title:d(e)?"عرض على الخريطة":"لا يوجد إحداثيات لهذا العنصر",children:[r.jsx(M,{size:16,"aria-hidden":!0}),"عرض على الخريطة"]})})]},e.id))}),r.jsxs("p",{className:"services-category-back-wrap",children:[r.jsxs("button",{type:"button",className:"services-category-back",onClick:()=>n(-1),children:[r.jsx(S,{size:18,"aria-hidden":!0}),"رجوع"]}),r.jsxs(u,{to:"/services",className:"services-category-back-alt",children:[r.jsx(z,{size:16,"aria-hidden":!0}),"كل الأقسام"]})]}),r.jsx("style",{dangerouslySetInnerHTML:{__html:`
