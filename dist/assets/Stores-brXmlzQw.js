import{n as F,u as P,r as a,p as R,v as T,j as r,L as D}from"./index-DwdOFtKv.js";import{M as U,m as $}from"./MainLayout-LB5HW8Va.js";import{g as q}from"./storePinDefaults-BR9yF6Rx.js";import{s as H}from"./storeCategories-CcVhHY8P.js";import{F as K}from"./FiltersDropdown-DS_838PO.js";const W=[31.5,34.4],v=12;function g(s){const n=Number(s==null?void 0:s.latitude),o=Number(s==null?void 0:s.longitude);return!(!Number.isFinite(n)||!Number.isFinite(o)||Math.abs(n)<.25&&Math.abs(o)<.25)}function _(s,n){const o=b=>b*Math.PI/180,j=o(n[0]-s[0]),i=o(n[1]-s[1]),h=Math.sin(j/2)**2,m=Math.cos(o(s[0]))*Math.cos(o(n[0]))*Math.sin(i/2)**2;return 2*6371*Math.asin(Math.sqrt(h+m))}function X(){const{userMapLocation:s,setManualMapLocation:n,requestUserLocation:o,locating:L,locationFocusNonce:j}=F(),i=s||W,h=P(),[m,b]=a.useState([]),[B,N]=a.useState(!0),[u,M]=a.useState([]),[C,k]=a.useState(!0),[d,E]=a.useState([]),[f,G]=a.useState(!1),[A,y]=a.useState(1);a.useEffect(()=>{let e=!0;return N(!0),R().then(t=>{e&&b(Array.isArray(t)?t:[])}).catch(()=>{e&&b([])}).finally(()=>{e&&N(!1)}),()=>{e=!1}},[]),a.useEffect(()=>{let e=!0;return k(!0),T(i[0],i[1],null).then(t=>{e&&M(Array.isArray(t)?t:[])}).catch(()=>{e&&M([])}).finally(()=>{e&&k(!1)}),()=>{e=!1}},[i[0],i[1]]),a.useEffect(()=>{y(1)},[d,f]);const S=a.useMemo(()=>{const e=Array.isArray(u)?u:[];return d.length===0?e:e.filter(t=>H(t,d))},[u,d]),w=a.useMemo(()=>S.filter(e=>f?g(e):!0),[S,f]),p=a.useMemo(()=>{if(!i)return w;const e=i;return[...w].sort((t,l)=>g(t)?g(l)?_(e,[Number(t.latitude),Number(t.longitude)])-_(e,[Number(l.latitude),Number(l.longitude)]):-1:1)},[w,i]),x=Math.max(1,Math.ceil(p.length/v)),c=Math.min(A,x),z=a.useMemo(()=>{const e=(c-1)*v;return p.slice(e,e+v)},[p,c]),I=a.useMemo(()=>p.filter(e=>g(e)).length,[p]);return d.length===0||`${d.length}`,r.jsx(U,{children:r.jsxs("div",{className:"stores-page",children:[r.jsxs("section",{className:"stores-hero","aria-label":"عنوان الصفحة وفتح الخريطة",children:[r.jsx("div",{className:"stores-head",children:r.jsxs("div",{className:"stores-head__titles",children:[r.jsx("h1",{className:"stores-title",children:"المتاجر"}),r.jsx("p",{className:"stores-sub",children:"فلترة سريعة + خريطة منبثقة عند الضغط."}),r.jsx("div",{className:"stores-controls",style:{marginTop:"14px",justifyContent:"flex-start"},children:r.jsx(K,{buttonLabel:"فلاتر",title:"فلترة المتاجر حسب الأقسام",allLabel:"كل الأقسام",options:(m||[]).map(e=>({id:e.id,label:e.name})),selectedIds:d,onChangeSelectedIds:e=>E(Array.isArray(e)?e:[])})})]})}),r.jsxs("button",{type:"button",className:"stores-mini-map",onClick:()=>h("/map"),"aria-label":"فتح الخريطة",children:[r.jsx("span",{className:"stores-mini-map__bg","aria-hidden":!0}),r.jsx("span",{className:"stores-mini-map__shine","aria-hidden":!0}),r.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"10px",flexWrap:"wrap",position:"relative",zIndex:1,width:"100%",justifyContent:"flex-start"},children:[r.jsxs("span",{className:"stores-mini-map__badge",style:{margin:0,padding:"8px 12px"},children:[r.jsx($,{size:16,strokeWidth:2,"aria-hidden":!0}),"اضغط لفتح الخريطة"]}),r.jsxs("span",{className:"stores-mini-map__hint",style:{margin:0},children:[I," متجر على الخريطة"]})]})]})]}),C?r.jsx("div",{className:"stores-loading",children:"جاري تحميل المتاجر…"}):z.length===0?r.jsx("div",{className:"stores-empty",children:"لا توجد متاجر ضمن الفلاتر الحالية."}):r.jsx("div",{className:"stores-grid",role:"list",children:z.map(e=>{const t=q(e,m),l=i&&g(e)?_(i,[Number(e.latitude),Number(e.longitude)]):null;return r.jsxs(D,{to:`/stores/${e.id}`,className:"store-card",role:"listitem",children:[r.jsxs("div",{className:"store-card__text",children:[r.jsx("div",{className:"store-card__name",children:e.store_name}),r.jsx("div",{className:"store-card__meta",children:r.jsx("span",{className:"store-card__dist",children:l!=null?`${l.toFixed(1)} كم`:"بدون مسافة"})})]}),r.jsx("div",{className:"store-card__thumb","aria-hidden":!0,children:t.type==="image"?r.jsx("img",{className:"store-card__thumb-img",src:t.url,alt:"",loading:"lazy",width:"800",height:"800"}):r.jsx("span",{className:"store-card__thumb-emoji",style:{background:t.bg},children:t.emoji})})]},e.id)})}),x>1?r.jsxs("div",{className:"stores-pager","aria-label":"تنقل الصفحات",children:[r.jsx("button",{type:"button",onClick:()=>y(e=>Math.max(1,e-1)),disabled:c<=1,children:"السابق"}),r.jsxs("span",{children:[c," / ",x]}),r.jsx("button",{type:"button",onClick:()=>y(e=>Math.min(x,e+1)),disabled:c>=x,children:"التالي"})]}):null,r.jsx("style",{dangerouslySetInnerHTML:{__html:`
          .stores-page {
            max-width: 1240px;
            margin-inline: auto;
